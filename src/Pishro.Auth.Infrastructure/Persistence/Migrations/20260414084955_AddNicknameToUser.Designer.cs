...
namespace Pishro.Auth.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260414084955_AddNicknameToUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pishro.Auth.Domain.Entities.PasskeyCredential", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Pishro.Auth.Domain.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Pishro.Auth.Domain.Entities.PasskeyCredential", b =>
                {
                    b.HasOne("Pishro.Auth.Domain.Entities.User", "User")
                        .WithMany("Passkeys")
